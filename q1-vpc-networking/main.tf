...
resource "aws_subnet" "public_a" {
  ...
  tags = {
    Name = "${local.name_prefix}_public_subnet_a"
  }
}
...
resource "aws_subnet" "public_b" {
  ...
  tags = {
    Name = "${local.name_prefix}_public_subnet_b"
  }
}
...
resource "aws_subnet" "private_a" {
  ...
  tags = {
    Name = "${local.name_prefix}_private_subnet_a"
  }
}
...
resource "aws_subnet" "private_b" {
  ...
  tags = {
    Name = "${local.name_prefix}_private_subnet_b"
  }
}
...
resource "aws_nat_gateway" "nat" {
  ...
  tags = {
    Name = "${local.name_prefix}_nat_gw"
  }
